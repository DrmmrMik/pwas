import{r as x,i as p,s as g,l as f,g as m,a as u,b as i,c as v,d as h,e as w,f as y,h as k,j as $,k as V,m as E,n as S,o as T,p as I,q as M,t as B}from"./settingsView-DCBmHUh9.js";x();function H(){const o=document.body.dataset.version||"0.1.0",s=document.body.dataset.build||"dev";return{version:o,build:s}}function a(){const o=document.getElementById("app");if(!o)return;const s=m(),e=u(),{version:r}=H(),d=s.settings.rainMode;let t="";switch(e){case"today":t=i(!1);break;case"itinerary":t=k(!1);break;case"map":t=y(!1);break;case"reservations":t=w(!1);break;case"packing":t=h(!1);break;case"ideas":t=B(!1);break;case"settings":t=v(!1);break;default:t=i(!1)}o.innerHTML=`
    <!-- Sticky Header -->
    ...
    <nav class="bg-slate-800/95 backdrop-blur border-t border-slate-700 p-1.5 fixed bottom-0 left-0 right-0 z-20 flex justify-around max-w-2xl mx-auto shadow-lg">
      ...
      <button
        data-tab="map"
        class="nav-tab-btn flex-1 py-2 px-1 rounded-lg text-center transition flex flex-col items-center gap-0.5 ${e==="map"?"bg-teal-600 text-white font-bold shadow":"text-slate-400 hover:bg-slate-750 hover:text-slate-200"}"
      >
        <span class="text-base">🗺️</span>
  ...
  `;const n=document.getElementById("main-content-container");if(n)switch(e){case"today":I(n,a);break;case"itinerary":T(n,a);break;case"map":S(n,a);break;case"reservations":E(n,a);break;case"packing":V(n,a);break;case"ideas":break;case"settings":$(n,a);break}document.querySelectorAll(".nav-tab-btn").forEach(b=>{b.addEventListener("click",c=>{const l=c.target.closest(".nav-tab-btn").dataset.tab;l&&M(l)})})}p().then(()=>{a(),g(()=>a()),f(()=>a())});
